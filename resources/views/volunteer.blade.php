                    ...
                    <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        <div class="text-center">
                            <div class="relative mb-4">
                                <img src="https://res.cloudinary.com/dpyppzvzj/image/upload/v1775457129/0304_233_zvkodm.jpg" alt="Spiritual Growth" class="w-full h-32 object-cover rounded-2xl">
                                <div class="absolute inset-0 bg-gradient-to-br from-slate-900/80 to-slate-700 rounded-2xl flex items-center justify-center">
                        ...
                        <div class="text-center">
                            <div class="relative mb-4">
                                <img src="https://res.cloudinary.com/dpyppzvzj/image/upload/v1775457145/0204_44_adnyre.jpg" alt="Community Impact" class="w-full h-32 object-cover rounded-2xl">
                                <div class="absolute inset-0 bg-gradient-to-br from-slate-800/80 to-slate-600 rounded-2xl flex items-center justify-center">
                        ...
                        <div class="text-center">
                            <div class="relative mb-4">
                                <img src="https://res.cloudinary.com/dpyppzvzj/image/upload/v1775457124/0304_sauiub.jpg" alt="Leadership Skills" class="w-full h-32 object-cover rounded-2xl">
                                <div class="absolute inset-0 bg-gradient-to-br from-slate-700/80 to-slate-500 rounded-2xl flex items-center justify-center">
                        ...
                        <div class="text-center">
                            <div class="relative mb-4">
                                <img src="https://res.cloudinary.com/dpyppzvzj/image/upload/v1775457162/0104_33_gh3ckn.jpg" alt="Network Building" class="w-full h-32 object-cover rounded-2xl">
                                <div class="absolute inset-0 bg-gradient-to-br from-slate-600/80 to-slate-400 rounded-2xl flex items-center justify-center">
                        ...
                        <div class="text-center">
                            <div class="relative mb-4">
                                <img src="https://res.cloudinary.com/dpyppzvzj/image/upload/v1775457159/0104_57_jbgeri.jpg" alt="Personal Fulfillment" class="w-full h-32 object-cover rounded-2xl">
                                <div class="absolute inset-0 bg-gradient-to-br from-slate-800/80 to-slate-600 rounded-2xl flex items-center justify-center">
                                    <i class="ph ph-trophy text-white text-2xl"></i>
                                </div>
                            </div>
                            <h3 class="text-xl font-bold text-slate-900 mb-2">Personal Fulfillment</h3>
                            <p class="text-slate-600">Experience joy and fulfillment that comes from serving others</p>
                        </div>
                    </div>
                </div>
            </section>
